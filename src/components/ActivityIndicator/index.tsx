...
import {Colors, getResWidth} from '@/theme';

export type IndiatorProps = React.ComponentPropsWithRef<typeof View> & {
  /**
...
const ActivityIndicator = ({
  animating = true,
  color: indicatorColor = Colors.secondPrimary,
